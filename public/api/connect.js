$(document).ready(function () {
	const url = "http://192.168.0.107/jobembed/api/";
	const key = $(".jprb").attr("id");
	...
	function createFrame(target, key) {
		var frame = document.createElement("iframe");
		frame.src = url + "template/" + key;
		frame.width = "100%";
		...
		iFrameResize(
			{
				...
				checkOrigin: false,
				bodyMargin: "25px 10px 90px 10px",
				warningTimeout: 0,
			},
			"#frame_" + key
		);
			...
			n &&
				...
				O(t, "load", function () {
					...
					B("iFrame.onload", i, t, u, !0),
						...
						!e &&
							n &&
							P({ iframe: t, height: 0, width: 0, type: "init" });
				}),
				B("init", i, t, u, !0);
		}
		function i(e) {
